            ...
            <div id="content-wrapper" class="bg-light">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">ブックリスト</li>
                    </ol>
                    ...
                    <div class="row bookSearchArea">
                        <table class="table table-sm table-height-sm table-condensed" style="font-size:10pt">
                            <tbody>
                                <tr>
                                    <div class="col-lg-6 m-2"><div class="px-2">検索条件</div>
                                    <div class="form-group">
                                        <input type="text" id="searchword" class="form-control"
                                            placeholder="本の名前を入力してください。" required="required" v-model="searchword" autocomplete="off"></div>
                                    </div>
                                </tr>
                            </tbody>
                        </table>
